...
function recPrism(width, height, length) {
...
function sphere(radius) {
  ...
  // Group 4.3 in () for order of operations (Understanding the Order of Operations: PEMDAS (Please Excuse My Dear Aunt Sally))
}
